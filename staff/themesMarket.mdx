...
### Example messages
Minor Case;
- `Hey @{user}, your theme (Theme Name) has been removed for (List Reason/s). Please review the the reasons provided and re-upload your theme after you have corrected it.`

Extreme Case;
- `Hey @{user}, your theme (Theme Name) has been removed from the marketplace. The severity of the case has resulted in a ban from publishing to the marketplace. If you believe this is in mistake, please contact support in our [community server](https://discord.gg/ermbot).`
