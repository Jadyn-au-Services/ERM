...
---
<Warning>By installing a theme, you agree to the guidelines below. You also agree at these guidelines may change at any time at the discretion of ERM.</Warning>

```The guidelines provided below are an example of what enforcement should be expected.```
```It is at the discretion of the staff for experiences not displayed below that provide a negative experience.```
...
As a theme user, you must follow these guidelines to ensure a smooth experience with the marketplace.

- Read the documentation before installing a theme.
- Report any themes that contain malicious code or malware.
- Leave a rating and review for themes you have used.
- Support theme developers by providing feedback.