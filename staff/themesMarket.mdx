...
```The guidelines provided below are an example of what enforcement should be expected. It is at the discretion of the staff for experiences not displayed below that provide a negative experience.```
